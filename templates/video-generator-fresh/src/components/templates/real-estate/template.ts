        ...
        'clips': [
          {
            'asset': {
              ...
              'css':
                'p { color: #ffffff; font-size: 56px; font-family: Montserrat ExtraBold; text-align: left }',
              'width': 1031,
              'height': 114,
            },
            'fit': 'none',
        ...
        'clips': [
          {
            'asset': {
              ...
              'css':
                'p { color: #ffffff; font-size: 22px; font-family: Montserrat SemiBold; text-align: left }',
              'width': 620,
              'height': 72,
            },
            'length': 5,
          ...
          },
          {
            'asset': {
              ...
              'css':
                'p { color: #ffffff; font-size: 24px; font-family: Montserrat ExtraBold; text-align: left; }',
              'width': 600,
              'height': 109,
            },
            'length': 5,
