          ...
          "clips": [
            {
              "asset": {
                ...
                "css": "h1 { color: #ffffff; font-size: 60px; font-family: Montserrat ExtraBold; text-align: center; }",
                "width": 1280,
                "height": 100
              },
              "start": 0,
            ...
            },
            {
              "asset": {
                ...
                "css": "p { color: #ffffff; font-size: 30px; font-family: Montserrat; text-align: center; }",
                "width": 1200,
                "height": 150
              },
              "start": 1,
          ...
          "clips": [
            {
              "asset": {
                "type": "html",
                "html": "<h2>Features</h2><ul><li>Bedrooms: {{Property_Bedrooms}}</li><li>Bathrooms: {{Property_Bathrooms}}</li><li>Area: {{Property_Area}} sq. ft.</li></ul>",
                "css": "h2 { color: #ffffff; font-size: 40px; font-family: Montserrat ExtraBold; text-align: left; } ul { color: #ffffff; font-size: 30px; font-family: Montserrat; text-align: left; }",
                "width": 1280,
                "height": 100
              },
              "start": 4,
          ...
          "clips": [
            {
              "asset": {
                "type": "html",
                "html": "<h2>Contact</h2><p>{{Agent_Name}}</p><p>{{Agent_Phone}}</p><p>{{Agent_Email}}</p>",
                "css": "h2 { color: #ffffff; font-size: 40px; font-family: Montserrat ExtraBold; text-align: left; } p { color: #ffffff; font-size: 30px; font-family: Montserrat; text-align: left; }",
                "width": 1280,
                "height": 100
              },
              "start": 6,
