...
export const INPUT_STYLES =
  "px-4 py-2 bg-transparent rounded rounded-lg outline-none border-1 border-gray-300 hover:border-black transition duration-100 disabled:opacity-50 disabled:cursor-not-allowed dark:hover:border-white";
...
export const LINK_STYLES =
  "text-gray-700 transition duration-100 hover:text-black hover:dark:text-white";
