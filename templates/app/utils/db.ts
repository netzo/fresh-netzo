 ...
 * @example
 * ```ts
 * import { collectValues, listItems, type Item } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createItem } from "netzo/authentication/utils/db.ts";
 ...
 * @example
 * ```ts
 * import { getItem } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listItems } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listItemsByUser } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createVote } from "netzo/authentication/utils/db.ts";
 *
 * await createVote({
 ...
 * @example
 * ```ts
 * import { listItemsVotedByUser } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createUser } from "netzo/authentication/utils/db.ts";
 *
 * await createUser({
 *   login: "john",
 *   sessionId: crypto.randomUUID(),
 ...
 * @example
 * ```ts
 * import { updateUser } from "netzo/authentication/utils/db.ts";
 *
 * await updateUser({
 *   login: "john",
 *   sessionId: crypto.randomUUID(),
 ...
 * @example
 * ```ts
 * import { updateUserSession } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getUserBySession } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listUsers } from "netzo/authentication/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getAreVotedByUser } from "netzo/authentication/utils/db.ts";
 *
 * const items = [
 *   {
