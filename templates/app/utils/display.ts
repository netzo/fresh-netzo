 ...
 * @example
 * ```ts
 * import { pluralize } from "netzo/authentication/utils/display.ts";
 *
 ...
 * @example
 * ```ts
 * import { timeAgo } from "netzo/authentication/utils/display.ts";
 ...
 * @example
 * ```ts
 * import { formatCurrency } from "netzo/authentication/utils/display.ts";
 *
