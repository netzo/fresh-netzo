...
export default {
  ...
  pricing: {
    ...
    items: [
      ...
      {
        title: 'Projects',
        description: 'Projects are web applications. Each project has its own deployments, databases, logs, and more.',
        start: '10',
        business: '20',
        enterprise: 'Custom',
      },
      {
        ...
        start: '25,000 per month',
        business: '50,000 per month',
        enterprise: 'Custom',
      },
      {
        title: 'Netzo-hosted Storage',
        description: '',
        start: '2GB',
        business: '5GB',
        enterprise: 'Custom',
      },
      {
        ...
        start: '1 GB per month',
        business: '1 GB per month',
        enterprise: 'Custom',
      },
      {
      ...
      {
        title: 'App launcher',
        description: 'Securely share your Projects in one-click.',
      ...
      {
        title: 'Inbox',
        description: 'Trigger custom notifications to a Users Inbox in a single line of code.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      {
        title: 'Studio (online IDE)',
        description: 'Full-feature code editor directly in your browser.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      ...
      },
      {
        ...
        description: 'Postman-like testing and debugging tool for Project requests.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      {
        title: 'Databases',
        description: 'Easily create and manage hosted databases for your Projects.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      {
        ...
        description: 'Integrate with hundreds of APIs through our SDK without reading docs or instantly create a client for custom APIs.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      ...
      },
      {
        ...
        description: 'Choose deployment regions for databases and projects with Region Selection.',
        start: { class: 'i-mdi-minus' },
        business: { class: 'i-mdi-minus' },
        enterprise: { class: 'i-mdi-clock-outline' },
      },
