...
export default {
  ...
  pricing: {
    ...
    items: [
      ...
      {
        title: 'Costo por usuario adicional',
        description: '',
        start: contactanos,
        business: contactanos,
        enterprise: 'Custom',
      },
      {
        title: 'Límites de usuarios',
        description: '',
        start: '10',
        business: '20',
      ...
      {
        title: 'Proyectos',
        description: 'Los proyectos son aplicaciones web. Cada proyecto tiene su propio despliegue, base de datos, logs y más.',
        start: '10',
        business: '20',
        enterprise: 'Custom',
      },
      ...
      {
        title: 'App launcher',
        description: 'Comparta de manera segura sus proyectos con un clic.',
      ...
      {
        title: 'Studio (IDE online)',
        description: 'Editor de código completo directamente en el navegador.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      ...
      },
      {
        ...
        description: 'Herramienta de prueba y depuración similar a Postman para las solicitudes de proyectos.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      {
        ...
        description: 'Cree y administre fácilmente bases de datos alojadas para sus proyectos.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      {
        ...
        description: 'Integra tus Proyectos con cientos de API a través de nuestro SDK sin necesidad de leer documentacion o crear instantáneamente clientes para tus APIs.',
        start: { class: 'i-mdi-check' },
        business: { class: 'i-mdi-check' },
        enterprise: { class: 'i-mdi-check' },
      },
      ...
      {
        title: 'Schedules',
        description: 'Ejecute Proyectos según un horario utilizando trabajos CRON.',
      ...
      },
      {
        ...
        description: 'Elija regiones de despliegue para las bases de datos y Proyectos.',
        start: { class: 'i-mdi-minus' },
        business: { class: 'i-mdi-minus' },
        enterprise: { class: 'i-mdi-clock-outline' },
      },
