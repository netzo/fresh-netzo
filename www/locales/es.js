...
export default {
  home: {
    ...
    //       description: '<strong style="color: #0080ff"><a href="/docs/use-cases/apps">Plantillas</a></strong> para comenzar implementaciones a medida en segundos',
    //     },
    //     {
    ...
    //   name: 'McKinsey',
    //   title: 'Junio 15, 2022',
    //   description: 'Casi el 70% de las principales empresas de alto rendimiento, en comparación con solo la mitad de sus pares, están utilizando su propio software para diferenciarse de sus competidores.',
    //   image: {
