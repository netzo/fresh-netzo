...
import type { SectionHeroSimple } from '../types'
...
const {
  ...
  buttons,
  image,
} = defineProps<SectionHeroSimple>()
</script>

<template>
  <section class="!text-center">
    <slot>
      <div class="container-wider grid grid-cols-1 xl:grid-cols-2 gap-10 text-center xl:text-left">
        <div class="container">
