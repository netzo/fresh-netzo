      ...
      items: [
        ...
        { text: '<code>cli</code>', link: '/docs/netzo/cli' },
        {
          ...
          items: [
            {
              text: '<code>data</code>',
              link: '/docs/netzo/ui/components#data',
              collapsed: true,
              items: [
                { text: '<code>NTable</code>', link: '/docs/netzo/ui/components/NTable' },
              ],
            },
            {
              text: '<code>elements</code>',
              link: '/docs/netzo/ui/components#elements',
              collapsed: true,
              items: [
                { text: '<code>NButton</code>', link: '/docs/netzo/ui/components/NButton' },
                { text: '<code>NChip</code>', link: '/docs/netzo/ui/components/NChip' },
                { text: '<code>NDarkToggle</code>', link: '/docs/netzo/ui/components/NDarkToggle' },
                { text: '<code>NDropdown</code>', link: '/docs/netzo/ui/components/NDropdown' },
                { text: '<code>NIcon</code>', link: '/docs/netzo/ui/components/NIcon' },
                { text: '<code>NIconButton</code>', link: '/docs/netzo/ui/components/NIconButton' },
                { text: '<code>NIconTitle</code>', link: '/docs/netzo/ui/components/NIconTitle' },
                { text: '<code>NLink</code>', link: '/docs/netzo/ui/components/NLink' },
                { text: '<code>NLoading</code>', link: '/docs/netzo/ui/components/NLoading' },
                { text: '<code>NTip</code>', link: '/docs/netzo/ui/components/NTip' },
              ],
            },
            {
              text: '<code>form</code>',
              link: '/docs/netzo/ui/components#form',
              collapsed: true,
              items: [
                { text: '<code>NCheckbox</code>', link: '/docs/netzo/ui/components/NCheckbox' },
                { text: '<code>NForm</code>', link: '/docs/netzo/ui/components/NForm' },
                { text: '<code>NInputText</code>', link: '/docs/netzo/ui/components/NInputText' },
                { text: '<code>NInputDate</code>', link: '/docs/netzo/ui/components/NInputDate' },
                { text: '<code>NInputDateRange</code>', link: '/docs/netzo/ui/components/NInputDateRange' },
                { text: '<code>NRadio</code>', link: '/docs/netzo/ui/components/NRadio' },
                { text: '<code>NSelect</code>', link: '/docs/netzo/ui/components/NSelect' },
                { text: '<code>NSwitch</code>', link: '/docs/netzo/ui/components/NSwitch' },
              ],
            },
            {
              text: '<code>layout</code>',
              link: '/docs/netzo/ui/components#layout',
              collapsed: true,
              items: [
                { text: '<code>NCard</code>', link: '/docs/netzo/ui/components/NCard' },
                { text: '<code>NPanelGrids</code>', link: '/docs/netzo/ui/components/NPanelGrids' },
                { text: '<code>NSectionBlock</code>', link: '/docs/netzo/ui/components/NSectionBlock' },
              ],
            },
            {
              text: '<code>overlay</code>',
              link: '/docs/netzo/ui/components#overlay',
              collapsed: true,
              items: [
                { text: '<code>NDialog</code>', link: '/docs/netzo/ui/components/NDialog' },
              ],
            },
          ],
        },
