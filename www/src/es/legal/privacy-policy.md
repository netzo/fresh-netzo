...
onMounted(async () => {
  if (window) await window.UCUI.updateLanguage("es");
})
const { page } = useData()
</script>
...
La presente política de privacidad (en adelante, la “Política de Privacidad”) se aplica a todos los datos de carácter personal que el Usuario facilite a Rokaware S.L. La presente política de privacidad se encuentra redactada y disponible en otros idiomas, prevaleciendo la versión en **español** ante cualquier contradicción entre versiones de otro idioma.

## 1. Identificación del responsable del tratamiento

De acuerdo con lo establecido en la normativa vigente, le informamos que los datos personales que facilite en su condición de **Usuario registrado** serán tratados en **calidad de** **Responsable del tratamiento** por: ROKAWARE S.L. (En lo sucesivo, Rokaware) con domicilio social Paseo de la Castellana 89, Planta 8va, 28046 Madrid, España.

Los datos personales se tratarán de conformidad con lo dispuesto en las normativas vigente, tales como el Reglamento (UE) 2016/679 de 27 de abril de 2016 (RGPD) y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales.

Podrá ponerse en contacto con el responsable del tratamiento a través del correo electrónico: [help@netzo.io](mailto:help@netzo.io).

Los términos en mayúsculas incluidos en esta política de privacidad se corresponden con las definiciones incluidas en las Condiciones Generales de Acceso a los Servicios Digitales.

## 2. Necesidad de facilitar datos personales

El alta como **Usuario registrado** implica la necesidad de proporcionar, al menos, los datos que se solicitan en el formulario de registro identificados como obligatorios. La negativa a proporcionar estos datos supone la imposibilidad de tramitar su registro como Usuario de la plataforma, y por lo tanto, de prestarle ninguna clase de servicio desde la misma.

Complementariamente, podrá facilitar otros datos adicionales solicitados en el formulario de registro o permitir la captación de datos relacionados con el uso de las Aplicaciones o los productos y servicios sobre los que muestre interés, con el objetivo de que puedan personalizarse de modo óptimo los servicios y ventajas vinculadas a su condición de **Usuario registrado**.
...
En concreto, los datos personales podrán ser comunicados a **Rokaware S.A.P.I.** domiciliada en Corinto 206, 66274 San Pedro Garza García, Mexico y **Asterisc GmbH i.L.** domiciliada en Tal 44, 80331 Munich, Alemania.
