...
```jsx
import { rest } from 'https://deno.land/x/netzo@v0.2.47/apis/rest/mod.ts'
...
```jsx
import { jsonplaceholder } from 'https://deno.land/x/netzo@v0.2.47/apis/jsonplaceholder/mod.ts'
