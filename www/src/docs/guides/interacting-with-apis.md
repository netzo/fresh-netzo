...
```jsx
import { rest } from 'https://deno.land/x/netzo@v0.2.32/apis/rest/mod.ts'
...
```jsx
import { jsonplaceholder } from 'https://deno.land/x/netzo@v0.2.32/apis/jsonplaceholder/mod.ts'
