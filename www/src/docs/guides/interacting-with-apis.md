...
```jsx
import { rest } from 'https://deno.land/x/netzo@v0.2.44/apis/rest/mod.ts'
...
```jsx
import { jsonplaceholder } from 'https://deno.land/x/netzo@v0.2.44/apis/jsonplaceholder/mod.ts'
