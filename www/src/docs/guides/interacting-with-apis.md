...
```jsx
import { rest } from 'https://deno.land/x/netzo@0.2.82/apis/rest/mod.ts'
...
```jsx
import { jsonplaceholder } from 'https://deno.land/x/netzo@0.2.82/apis/jsonplaceholder/mod.ts'
