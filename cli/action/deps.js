...
class APIError extends Error {
  ...
  toString() {
    ...
    if (this.xDenoRay !== null) {
      ...
      error += '\nIf you encounter this error frequently,' + ' contact us at help@netzo.io with the above x-deno-ray.';
    }
    return error;
  }
}
class API {
  ...
  async *pushDeployJson(projectId, body) {
    try {
      ...
      const result = await this.#requestJson(`/projects/${projectId}`, {
        method: 'PATCH',
        body
      });
      yield {
