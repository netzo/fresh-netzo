 ...
 * @example
 * ```ts
 * import { pluralize } from "netzo/plugins/auth/utils/display.ts";
 *
 ...
 * @example
 * ```ts
 * import { timeAgo } from "netzo/plugins/auth/utils/display.ts";
 ...
 * @example
 * ```ts
 * import { formatCurrency } from "netzo/plugins/auth/utils/display.ts";
 *
