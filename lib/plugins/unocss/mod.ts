...
// Inline reset from https://esm.sh/@unocss/reset@0.58.0/tailwind-compat.css?target=esnext
...
export const unocss = (
  { config, aot = true, ssr = true, csr = true }: UnocssOptions = {},
): Plugin => {
  ...
  return {
    ...
    entrypoints: csr
      ? {
        ...
        import init from "https://esm.sh/@unocss/runtime@0.58.0?target=esnext";
