...
function Wt(e) {
  return ot.test(e)
    ? e.replace(ot, (t, r, n, s) => `[${H(r)}${n}"${H(s)}"]`)
    : `.${H(e)}`;
}
var D,
  a,
...
function I1(e) {
  (!e.__d && (e.__d = !0) && C.push(e) && !A.__r++ ||
    j !== a.debounceRendering) && ((j = a.debounceRendering) || K1)(A);
}
function A() {
...
function ee1(e, _, t, i, o, r, l, s, f, u, p) {
  var n, m, c, h, k, v = i && i.__k || X, d = _.length;
  for (t.__d = f, ie(t, _, v), f = t.__d, n = 0; n < d; n++) {
    (c = t.__k[n]) != null && typeof c != "boolean" && typeof c != "function" &&
      (m = c.__i === -1 ? E : v[c.__i] || E,
        c.__i = n,
        B(e, c, m, o, r, l, s, f, u, p),
        h = c.__e,
        c.ref && m.ref != c.ref &&
        (m.ref && O(m.ref, null, c), p.push(c.ref, c.__c || h, c)),
        k == null && h != null && (k = h),
        65536 & c.__u || m.__k === c.__k
          ? f = _e(c, f, e)
    ...
    (o =
        e.__k[i] =
          (o = _[i]) == null || typeof o == "boolean" || typeof o == "function"
            ...
            : F(o)
            ? S(H1, { children: o }, null, null, null)
...
function se(e, _, t, i) {
  ...
  if (i > (f != null && !(131072 & f.__u) ? 1 : 0)) {
    for (; l >= 0 || s < _.length;) {
      if (l >= 0) {
        if ((f = _[l]) && !(131072 & f.__u) && o == f.key && r === f.type) {
          return l;
        }
        l--;
      }
      if (s < _.length) {
        if ((f = _[s]) && !(131072 & f.__u) && o == f.key && r === f.type) {
          return s;
        }
        s++;
      }
  ...
  e: if (_ === "style") {
    if (typeof t == "string") e.style.cssText = t;
      ...
      if (typeof i == "string" && (e.style.cssText = i = ""), i) {
        for (_ in i) t && _ in t || z1(e.style, _, "");
      }
      if (t) for (_ in t) i && t[_] === i[_] || z1(e.style, _, t[_]);
    }
  } else if (_[0] === "o" && _[1] === "n") {
...
function B(e, _, t, i, o, r, l, s, f, u) {
  ...
  128 & t.__u && (f = !!(32 & t.__u), r = [s = _.__e = t.__e]),
    (p = a.__b) && p(_);
  e: if (typeof g == "function") {
    try {
      if (
        d = _.props,
          ...
          t.__c
            ...
            : ("prototype" in g && g.prototype.render
              ? _.__c = n = new g(d, x)
              : (_.__c = n = new W(d, x), n.constructor = g, n.render = ce),
              y && y.sub(n),
              n.props = d,
              n.state || (n.state = {}),
              n.context = x,
          ...
          (n.__s == n.state && (n.__s = b1({}, n.__s)),
            b1(n.__s, g.getDerivedStateFromProps(d, n.__s))),
          c = n.props,
          h = n.state,
          n.__v = _,
          m
        ...
        if (
          g.getDerivedStateFromProps == null && d !== c &&
      ...
      n.state = n.__s,
        n.getChildContext != null && (i = b1(b1({}, i), n.getChildContext())),
        m || n.getSnapshotBeforeUpdate == null ||
        (k = n.getSnapshotBeforeUpdate(c, h)),
        ee1(
          e,
          F(
              N = p != null && p.type === H1 && p.key == null
                ? p.props.children
                : p,
            )
            ? N
      ...
      _.__v = null,
        f || r != null
          ? (_.__e = s, _.__u |= f ? 160 : 32, r[r.indexOf(s)] = null)
          : (_.__e = t.__e, _.__k = t.__k),
        a.__e(L, _, t);
    }
  } else {r == null && _.__v === t.__v
      ? (_.__k = t.__k, _.__e = t.__e)
      : _.__e = ue(t.__e, _, t, i, o, r, l, f, u);}
  (p = a.diffed) && p(_);
}
function te(e, _, t) {
  _.__d = void 0;
  ...
  if (y === null) v === d || s && e.data === d || (e.data = d);
    ...
    if (r = r && D.call(e.childNodes), v = t.props || E, !s && r != null) {
      for (v = {}, u = 0; u < e.attributes.length; u++) {
        v[(c = e.attributes[u]).name] = c.value;
      }
    }
    for (u in v) {
      c = v[u],
    ...
    for (u in d) {
      c = d[u],
        u == "children"
          ...
          : u == "checked"
          ? k = c
          : u === "key" || s && typeof c != "function" || v[u] === c ||
            M(e, u, c, v[u], o);
    }
    if (p) {
...
D = X.slice,
  ...
  W.prototype.setState = function (e, _) {
    ...
    t = this.__s != null && this.__s !== this.state
      ? this.__s
      : this.__s = b1({}, this.state),
      typeof e == "function" && (e = e(b1({}, t), this.props)),
      e && b1(t, e),
      e != null && this.__v && (_ && this._sb.push(_), I1(this));
  },
  W.prototype.forceUpdate = function (e) {
    this.__v && (this.__e = !0, e && this.__h.push(e), I1(this));
  },
  W.prototype.render = H1,
  C = [],
  K1 = typeof Promise == "function"
...
function V5([, e], { theme: t }) {
  let r = b(t.fontSize?.[e])?.[0] ?? m5.bracket.cssvar.global.rem(e);
...
var p3 = [{
    ...
    getCSS(r) {
      if (r.theme.preflightBase) {
        let t = z(Object.entries(r.theme.preflightBase));
        return b(r.theme.preflightRoot ?? ["*,::before,::after", "::backdrop"])
          .map((a) => `${a}{${t}}`).join("");
      }
    },
  }],
...
function getColorTheme(color) {
  ...
  if (typeof color === "string") ({ light, dark } = getBuiltInTheme(color));
    ...
    ({ light, dark } = K(getBuiltInTheme(color.base), color.color));
