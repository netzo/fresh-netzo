...
import { AuthenticationState } from "../plugin.ts";
import { cn } from "netzo/components/utils.ts";
import { buttonVariants } from "netzo/components/ui/button.tsx";

export type AuthenticationPageProps = PageProps<unknown, AuthenticationState>;

export default (props: AuthenticationPageProps) => {
