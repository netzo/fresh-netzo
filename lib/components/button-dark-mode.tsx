...
export function ButtonDarkMode({ className, ...props }: ButtonDarkModeProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "i-mdi-white-balance-sunny h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0",
          darkMode.value === true && "hidden",
        )}
      />
      <div
        className={cn(
          "i-mdi-weather-night h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100",
