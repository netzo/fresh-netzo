 ...
 * @example
 * ```ts
 * import { collectValues, listItems, type Item } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createItem } from "netzo/auth/utils/db.ts";
 ...
 * @example
 * ```ts
 * import { getItem } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listItems } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listItemsByUser } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createVote } from "netzo/auth/utils/db.ts";
 *
 * await createVote({
 ...
 * @example
 * ```ts
 * import { listItemsVotedByUser } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { createUser } from "netzo/auth/utils/db.ts";
 *
 * await createUser({
 *   login: "john",
 *   sessionId: crypto.randomUUID(),
 ...
 * @example
 * ```ts
 * import { updateUser } from "netzo/auth/utils/db.ts";
 *
 * await updateUser({
 *   login: "john",
 *   sessionId: crypto.randomUUID(),
 ...
 * @example
 * ```ts
 * import { updateUserSession } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listUsers } from "netzo/auth/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getAreVotedByUser } from "netzo/auth/utils/db.ts";
 *
 * const items = [
 *   {
