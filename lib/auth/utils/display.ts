 ...
 * @example
 * ```ts
 * import { pluralize } from "netzo/auth/utils/display.ts";
 *
 ...
 * @example
 * ```ts
 * import { timeAgo } from "netzo/auth/utils/display.ts";
 ...
 * @example
 * ```ts
 * import { formatCurrency } from "netzo/auth/utils/display.ts";
 *
